...
#ifdef USE_GL1
#define HARDWARE_TEX_FORMATS (TEX_FORMAT_RGBA | TEX_FORMAT_RGB | TEX_FORMAT_ALPHA | TEX_FORMAT_GRAY | TEX_FORMAT_GRAY_ALPHA | TEX_FORMAT_4444 | TEX_FORMAT_5551 | TEX_FORMAT_565)
#define TEXTURE_POWER_OF_TWO true
#define NO_COLOR_OFF_ATTRIB
#elif defined(USE_GLES2)
#define HARDWARE_TEX_FORMATS (TEX_FORMAT_RGBA | TEX_FORMAT_RGB | TEX_FORMAT_ALPHA | TEX_FORMAT_GRAY | TEX_FORMAT_GRAY_ALPHA)
...
#else
#define HARDWARE_TEX_FORMATS (TEX_FORMAT_RGBA | TEX_FORMAT_BGRA | TEX_FORMAT_RGB | TEX_FORMAT_BGR | TEX_FORMAT_ALPHA | TEX_FORMAT_GRAY | TEX_FORMAT_GRAY_ALPHA | TEX_FORMAT_4444 | TEX_FORMAT_5551 | TEX_FORMAT_565)
#endif
